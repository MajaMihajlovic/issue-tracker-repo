...
Controller.factory = function(alias, config, more) {
	if (isFunction(alias)) {
		...
		return new Controller(_extends({}, config, more, result));
	}

	return new Controller(_extends({}, config, more));
};

var InstanceStoreProxy = (function(_View) {
	inherits(InstanceStoreProxy, _View);

	function InstanceStoreProxy(instance) {
		classCallCheck(this, InstanceStoreProxy);
		...
		Object.defineProperty(_this2, "store", {
			get: function get$$1() {
	...
	InstanceStoreProxy.prototype.getData = function getData() {
		return this.store.getData();
	};

	return InstanceStoreProxy;
})(View);
	...
	return createComponentFactory(function() {
		...
		if (props && isArray(props.jsxAttributes || props.jsxSpread)) {
			...
			var visible = props.visible,
				...
				putInto = props.putInto,
				contentFor = props.contentFor;
